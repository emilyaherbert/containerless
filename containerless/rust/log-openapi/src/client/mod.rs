    ...
    C: Clone + Send + Sync + 'static,
{
    ...
    pub fn try_new_with_connector(
        base_path: &str, protocol: Option<&'static str>, connector: Connector,
    ...
    C: Clone + Send + Sync + 'static,
{
    ...
    pub fn try_new_https_pinned<CA>(
        base_path: &str, ca_certificate: CA,
    ) -> Result<Self, ClientInitError>
    where
        CA: AsRef<Path>,
    {
    ...
    pub fn try_new_https_mutual<CA, K, D>(
        base_path: &str, ca_certificate: CA, client_key: K, client_certificate: D,
    ) -> Result<Self, ClientInitError>
    where
        CA: AsRef<Path>,
        K: AsRef<Path>,
    ...
    C: Clone + Send + Sync + 'static,
{
    ...
    pub fn try_new_with_client_service(
        client_service: S, base_path: &str,
    ) -> Result<Self, ClientInitError> {
        Ok(Self {
            client_service,
            base_path: into_base_path(base_path, None)?,
    ...
    C: Has<XSpanIdString> + Clone + Send + Sync + 'static,
{
    ...
    async fn log_post(
        &self, param_inline_object: models::InlineObject, context: &C,
        ...
        // Body parameter
        let body =
            serde_json::to_string(&param_inline_object).expect("impossible to fail to serialize");
