...
CONFIG1="{\"bind_port\":8081,\"image_name\":\"serverless-function\",\"max_containers\":5,\"initial_state\":\"Tracing\",\"utilization_log\":\"${OUTPUT_PATH}_C/${OPEN_CONNECTIONS}.log\",\"kill_parent\":true}"
